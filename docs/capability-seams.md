...
| `ctx.teamBattle` | `core` | [`experimental-team-battle`](../packages/experimental/team-battle) | - | [`experimental-team-battle-connector-http`](../packages/experimental/team-battle-connector-http), [`experimental-client-ui-team-battle`](../packages/experimental/client-ui-team-battle) | - | Owns the durable project roster, task board, artifact reviews, Query weapon grants, and browser projection. |
