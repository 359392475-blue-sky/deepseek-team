...
flowchart LR
  ...
  pkg_experimental_team_battle["experimental-team-battle"]
  svc_teamBattle["ctx.teamBattle<br/>Team Battle project coordination"]
  pkg_experimental_team_battle_connector_http["experimental-team-battle-connector-http"]
  pkg_experimental_client_ui_team_battle["experimental-client-ui-team-battle"]
  ...
  pkg_experimental_team_battle --> svc_teamBattle
  ...
  svc_teamBattle --> pkg_experimental_client_ui_team_battle
  svc_teamBattle --> pkg_experimental_team_battle_connector_http
...
| `ctx.teamBattle` | `core` | [`experimental-team-battle`](../packages/experimental/team-battle) | - | [`experimental-team-battle-connector-http`](../packages/experimental/team-battle-connector-http), [`experimental-client-ui-team-battle`](../packages/experimental/client-ui-team-battle) | - | 管理持久项目成员、任务看板、产物评审、Query 武器发放和浏览器投影。 |
