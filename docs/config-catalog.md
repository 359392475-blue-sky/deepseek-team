...
Requires: `webServer` · `credentials` · `teamBattle`
...
Source: [`packages/experimental/team-battle-connector-http/src/index.ts:25`](../packages/experimental/team-battle-connector-http/src/index.ts)
