...
English | [中文](team-battle.zh.md)

The Team Battle API exposes independent team spaces, invitations, members, tasks, confirmed context, files, and review state. The [package README](../../packages/experimental/team-battle/README.md) owns authorization, storage limits, and connector delivery behavior; [`types.ts`](../../packages/experimental/team-battle/src/types.ts) defines directory, invitation, network, and collaboration request and result types. This page collects Cordis methods and events generated from the service source.
