<!-- Archived dependency notice from the prototype source snapshot.
     Package versions and terms remain historical; source links use the maintained repository. -->
...
| --- | --- | --- | --- |
| `@deepseek-ai/cosmokit` | `cosmokit` | [vendor/cosmokit](https://github.com/deepseek-ai/deepseek-harness/tree/master/vendor/cosmokit) | MIT |
| `@deepseek-ai/schemastery` | `schemastery` | [vendor/schemastery](https://github.com/deepseek-ai/deepseek-harness/tree/master/vendor/schemastery) | MIT |
...
| `@deepseek-ai/cordis-plugin-include` | `@cordisjs/plugin-include` | [vendor/include](https://github.com/deepseek-ai/deepseek-harness/tree/master/vendor/include) | MIT |
| `@deepseek-ai/cordis-plugin-group` | `@cordisjs/plugin-group` | [vendor/group](https://github.com/deepseek-ai/deepseek-harness/tree/master/vendor/group) | MIT |
| `@deepseek-ai/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [vendor/timer](https://github.com/deepseek-ai/deepseek-harness/tree/master/vendor/timer) | MIT |
| `@deepseek-ai/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [vendor/hmr](https://github.com/deepseek-ai/deepseek-harness/tree/master/vendor/hmr) | MIT |
| `@deepseek-ai/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [vendor/logger-console](https://github.com/deepseek-ai/deepseek-harness/tree/master/vendor/logger-console) | MIT |
