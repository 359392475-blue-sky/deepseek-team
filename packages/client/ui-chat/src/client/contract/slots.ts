...
export type ChatViewSlotProps =
  ...
  & PropsRenderSlots<
    'conversation.chat.node' | 'conversation.message.images' | 'conversation.chat.sidecar'
  >
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  ...
  interface SlotMap {
    /**
     * Optional companion surface beside the live Chat transcript. A single
     * registration receives the current Session standard props. Without an
     * occupant, Chat keeps its transcript-only DOM layout and composer width.
     */
