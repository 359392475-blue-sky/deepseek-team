...
export const zh = {
  ...
  'message.failure.quota': '模型服务余额或额度不足。请检查该模型账户的余额和用量限制，处理后发送“继续”，或切换可用模型。已有对话已保留。',
...
export const en = {
  ...
  'message.failure.quota': 'The model account has insufficient balance or quota. Check its balance and usage limits, then send “continue” after resolving the limit, or switch to an available model. Your conversation is preserved.',
