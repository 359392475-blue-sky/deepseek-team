...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:279',
  },
  {
  ...
  {
    key: 'conversation.chat.sidecar',
    kind: 'single',
    scope: 'session',
    summary: 'Optional companion surface beside the live Chat transcript.',
    doc: 'Optional companion surface beside the live Chat transcript. A single\nregistration receives the current Session standard props. Without an\noccupant, Chat keeps its transcript-only DOM layout and composer width.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation.view\' (client-ui-chat), so it exists while that entry is mounted',
    occupants: [
      'experimental-client-ui-team-battle FlightGamePanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Additional actions below the blank-session headline.',
    doc: 'Additional actions below the blank-session headline.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'factory \'conversation.content\' (client-ui-conversation), so it exists while that definition is registered',
    occupants: [
      'experimental-client-ui-team-battle TeamHomeActions id \'team-projects\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.hero.badge',
    kind: 'single',
    scope: 'root',
    summary: 'Deployment badge beside the blank-session headline.',
    doc: 'Deployment badge beside the blank-session headline.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'factory \'conversation.content\' (client-ui-conversation), so it exists while that definition is registered',
    occupants: [
      'experimental-client-ui-team-battle TeamEditionBadge',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.session.header.collaboration',
    kind: 'list',
    scope: 'session',
    summary: 'Workspace collaboration shown for blank and active Sessions.',
    doc: 'Workspace collaboration shown for blank and active Sessions.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'experimental-client-ui-team-battle TeamConversationMembers id \'team-members\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.session.header.collaboration\', () => ctx.slots.register(\n      { name: \'conversation.session.header.collaboration\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-client-ui-team-battle TeamSpaceView id \'team\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-client-ui-team-battle RootTeamSpace',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-client-ui-team-battle TeamSpaceEntry',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Additive project sections above the personal workspace browser.',
    doc: 'Additive project sections above the personal workspace browser.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'experimental-client-ui-team-battle TeamProjectSidebar id \'team-projects\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.sections\', () => ctx.slots.register(\n      { name: \'sidebar.sections\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:105',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:152',
  },
  {
