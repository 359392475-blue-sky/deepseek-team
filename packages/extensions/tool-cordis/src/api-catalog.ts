...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  {
    key: 'teamBattle',
    summary: 'Team collaboration Remote namespace; shared member tokens never authorize private Host APIs.',
    description: 'Team collaboration Remote namespace; shared member tokens never authorize private Host APIs.',
    methods: [
      {
        signature: 'registerNetworkTransport(transport: TeamBattleNetworkTransport): () => void',
        description: 'Register the dedicated connector.',
        parameters: [{ name: 'transport', description: 'team-only transport provider.' }],
        returns: 'registration disposer.',
      },
      {
        signature: '@Remote(\'teams\') teams(): Promise<TeamBattleDirectoryView>',
        description: 'List spaces without sharing private conversations or credentials.',
        parameters: [],
      ...
      {
        signature: '@Remote(\'createInvite\') createInvite(request: CreateTeamInviteRequest): Promise<CreatedTeamInvite>',
        description: 'Create one member-bound invitation.',
        parameters: [{ name: 'request', description: 'selected team and invited identity.' }],
        returns: 'secret invitation shown once.',
      },
      {
        signature: '@Remote(\'revokeInvite\') revokeInvite(request: RevokeTeamInviteRequest): Promise<TeamBattleTeamSummary>',
        description: 'Revoke an unused or retained invitation.',
        parameters: [{ name: 'request', description: 'team and invitation.' }],
        returns: 'updated owner summary.',
      },
      {
        signature: '@Remote(\'revokeMember\') revokeMember(request: RevokeTeamMemberRequest): Promise<TeamBattleTeamSummary>',
        description: 'Revoke one member\'s access while retaining attribution.',
        parameters: [{ name: 'request', description: 'team and member.' }],
        returns: 'updated owner summary.',
      },
      {
      ...
      },
      {
        ...
        description: 'Read the separate listener state.',
        parameters: [],
        returns: 'hosting status.',
      },
      {
        signature: '@Remote(\'startHosting\') startHosting(request: { readonly host: string; readonly port: number }): Promise<TeamBattleHostingStatus>',
        description: 'Explicitly start the independent team listener.',
        parameters: [{ name: 'request', description: 'network interface and port.' }],
        returns: 'bound addresses.',
      },
      {
        signature: '@Remote(\'stopHosting\') stopHosting(): Promise<TeamBattleHostingStatus>',
        description: 'Stop the independent listener.',
        parameters: [],
        returns: 'stopped status.',
      },
      {
        signature: 'createHostedTeam(request: CreateHostedTeamRequest): Promise<TeamBattleTeamSummary>',
        description: 'Create server-owned state after connector deployment authorization.',
        parameters: [{ name: 'request', description: 'initial owner and credential.' }],
        returns: 'created metadata.',
      },
      {
        signature: 'acceptInvite(request: AcceptTeamInviteRequest): Promise<TeamBattleTeamSummary>',
        description: 'Bind a credential to the identity reserved by an invitation.',
        parameters: [{ name: 'request', description: 'invitation exchange.' }],
        returns: 'joined member metadata.',
      },
      {
        signature: 'dispatchAuthenticated(request: AuthenticatedTeamRequest): Promise<unknown>',
        description: 'Authorize and execute one dedicated-listener operation.',
        parameters: [{ name: 'request', description: 'member credential and untrusted command.' }],
        returns: 'bounded team result.',
      },
      {
        signature: '@Remote(\'view\') async view(request?: TeamBattleActorRequest): Promise<TeamBattleView>',
        description: 'Execute view in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'space\') async space(request?: TeamBattleActorRequest): Promise<TeamBattleSpaceView>',
        description: 'Execute space in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'createFolder\') async createFolder(request: CreateFolderRequest): Promise<TeamBattleSpaceView>',
        description: 'Execute createFolder in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'publishFile\') async publishFile(request: PublishFileRequest): Promise<TeamBattleSpaceView>',
        description: 'Execute publishFile in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'updateSpaceItem\') async updateSpaceItem(request: UpdateSpaceItemRequest): Promise<TeamBattleSpaceView>',
        description: 'Execute updateSpaceItem in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'readFile\') async readFile(request: ReadFileRequest): Promise<TeamBattleFileContent>',
        description: 'Execute readFile in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'sendFile\') async sendFile(request: SendFileRequest): Promise<TeamBattleSpaceView>',
        description: 'Execute sendFile in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'submitFile\') async submitFile(request: SubmitFileRequest): Promise<TeamBattleView>',
        description: 'Execute submitFile in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'createTask\') async createTask(request: CreateTaskRequest): Promise<TeamBattleView>',
        description: 'Execute createTask in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'updateTask\') async updateTask(request: UpdateTaskRequest): Promise<TeamBattleView>',
        description: 'Execute updateTask in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'publishContext\') async publishContext(request: PublishContextRequest): Promise<TeamBattleView>',
        description: 'Execute publishContext in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'publishArtifact\') async publishArtifact(request: PublishArtifactRequest): Promise<TeamBattleView>',
        description: 'Execute publishArtifact in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'reviewArtifact\') async reviewArtifact(request: ReviewArtifactRequest): Promise<TeamBattleView>',
        description: 'Execute reviewArtifact in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'consumeWeapon\') async consumeWeapon(request: ConsumeWeaponRequest): Promise<TeamBattleView>',
        description: 'Execute consumeWeapon in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: '@Remote(\'heartbeat\') async heartbeat(request: HeartbeatRequest): Promise<TeamBattleView>',
        description: 'Execute heartbeat in the request\'s selected team.',
        parameters: [{ name: 'request', description: 'team selector and operation fields.' }],
        returns: 'selected team result after durability.',
      },
      {
        signature: 'ingest(event: TeamBattleIngressEvent): Promise<TeamBattleIngressReceipt>',
        description: 'Admit a content-free local connector event to the legacy space.',
        parameters: [{ name: 'event', description: 'strict Query identity.' }],
        returns: 'durable idempotent receipt.',
      },
      {
        signature: 'pullDelivery(request: PullDeliveryRequest): TeamBattleDeliveryPull',
        description: 'Read a legacy connector\'s pending delivery.',
        parameters: [{ name: 'request', description: 'configured local member.' }],
        returns: 'oldest queued bytes.',
      },
      {
        signature: 'acknowledgeDelivery(request: AcknowledgeDeliveryRequest): Promise<TeamBattleDeliveryView>',
        description: 'Record a legacy connector receipt.',
        parameters: [{ name: 'request', description: 'terminal delivery acknowledgement.' }],
...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  {
    name: 'team-battle/changed',
    mode: 'emit',
    signature: '\'team-battle/changed\'(view: TeamBattleView): void',
    summary: 'A project mutation reached durable storage.',
    description: 'A project mutation reached durable storage.',
    parameters: [{ name: 'view', description: 'committed project projection.' }],
  },
  {
    name: 'tools/change',
    mode: 'emit',
...
export const TYPE_API: readonly TypeApiEntry[] = [
  {
    name: 'AcceptTeamInviteRequest',
    declaration: 'export interface AcceptTeamInviteRequest {\n    readonly teamId: TeamBattleProjectId;\n    readonly inviteToken: string;\n    readonly memberToken: string;\n}',
  },
  {
    name: 'AccountDetails',
  ...
  {
    name: 'AuthenticatedTeamRequest',
    declaration: 'export interface AuthenticatedTeamRequest {\n    readonly teamId: TeamBattleProjectId;\n    readonly memberToken: string;\n    readonly method: string;\n    readonly input: unknown;\n}',
  },
  {
  ...
  {
    name: 'ConsumeWeaponRequest',
    declaration: 'export interface ConsumeWeaponRequest extends TeamBattleActorRequest {\n    readonly weaponId: TeamBattleWeaponId;\n}',
  },
  {
  ...
  {
    name: 'CreatedTeamInvite',
    declaration: 'export interface CreatedTeamInvite extends TeamBattleInviteView {\n    readonly teamId: TeamBattleProjectId;\n    readonly token: string;\n    readonly inviteCode: string;\n}',
  },
  {
    name: 'CreateFolderRequest',
    declaration: 'export interface CreateFolderRequest extends TeamBattleActorRequest {\n    readonly name: string;\n    readonly parentId?: TeamBattleFolderId;\n}',
  },
  {
  ...
  {
    name: 'CreateHostedTeamRequest',
    declaration: 'export interface CreateHostedTeamRequest {\n    readonly name: string;\n    readonly goal: string;\n    readonly memberName: string;\n    readonly memberRole: string;\n    readonly ownerMemberToken: string;\n}',
  },
  {
  ...
  },
  {
    ...
    declaration: 'export interface CreateTaskRequest extends TeamBattleActorRequest {\n    readonly title: string;\n    readonly description: string;\n    readonly weight: number;\n}',
  },
  {
    name: 'CreateTeamInviteRequest',
    declaration: 'export interface CreateTeamInviteRequest {\n    readonly teamId: TeamBattleProjectId;\n    readonly memberName: string;\n    readonly memberRole: string;\n    readonly expiresInHours?: number;\n    readonly origin?: string;\n}',
  },
  {
    name: 'CreateTeamRequest',
    declaration: 'export interface CreateTeamRequest {\n    readonly serverUrl?: string;\n    readonly serverAccessToken?: string;\n    readonly name: string;\n    readonly goal: string;\n    readonly memberName: string;\n    readonly memberRole: string;\n}',
  },
  {
  ...
  },
  {
    ...
    declaration: 'export interface HeartbeatRequest extends TeamBattleActorRequest {\n    readonly status: TeamBattleMemberStatus;\n}',
  },
  {
  ...
  {
    name: 'JoinRemoteTeamRequest',
    declaration: 'export interface JoinRemoteTeamRequest {\n    readonly inviteCode: string;\n}',
  },
  {
    name: 'JsonSchemaNode',
  ...
  },
  {
    ...
    declaration: 'export interface PublishArtifactRequest extends TeamBattleActorRequest {\n    readonly taskId: TeamBattleTaskId;\n    readonly name: string;\n    readonly mediaType: string;\n    readonly uri: string;\n    readonly sha256: string;\n    readonly bytes: number;\n}',
  },
  {
    name: 'PublishContextRequest',
    declaration: 'export interface PublishContextRequest extends TeamBattleActorRequest {\n    readonly summary: string;\n    readonly decisions?: readonly string[];\n    readonly blockers?: readonly string[];\n    readonly nextSteps?: readonly string[];\n    readonly sourceRefs?: readonly string[];\n}',
  },
  {
    name: 'PublishFileRequest',
    declaration: 'export interface PublishFileRequest extends TeamBattleActorRequest {\n    readonly name: string;\n    readonly parentId?: TeamBattleFolderId;\n    readonly mediaType: string;\n    readonly contentBase64: string;\n    readonly versionLabel: string;\n    readonly note: string;\n    readonly source: string;\n}',
  },
  {
    name: 'PullDeliveryRequest',
    declaration: 'export interface PullDeliveryRequest {\n    readonly memberId: TeamBattleMemberId;\n}',
  },
  {
    name: 'QueueAction',
  ...
  },
  {
    ...
    declaration: 'export interface ReadFileRequest extends TeamBattleActorRequest {\n    readonly fileId: TeamBattleFileId;\n}',
  },
  {
    name: 'ReadOnlyReason',
  ...
  {
    name: 'ReviewArtifactRequest',
    declaration: 'export interface ReviewArtifactRequest extends TeamBattleActorRequest {\n    readonly artifactId: TeamBattleArtifactId;\n    readonly expectedRevision: number;\n    readonly decision: \'accepted\' | \'rejected\';\n    readonly note?: string;\n}',
  },
  {
    name: 'RevokeTeamInviteRequest',
    declaration: 'export interface RevokeTeamInviteRequest {\n    readonly teamId: TeamBattleProjectId;\n    readonly inviteId: string;\n}',
  },
  {
    name: 'RevokeTeamMemberRequest',
    declaration: 'export interface RevokeTeamMemberRequest {\n    readonly teamId: TeamBattleProjectId;\n    readonly memberId: TeamBattleMemberId;\n}',
  },
  {
    name: 'RpcId',
  ...
  },
  {
    ...
    declaration: 'export interface SendFileRequest extends TeamBattleActorRequest {\n    readonly fileId: TeamBattleFileId;\n    readonly expectedRevision: number;\n}',
  },
  {
  ...
  {
    name: 'SubmitFileRequest',
    declaration: 'export interface SubmitFileRequest extends TeamBattleActorRequest {\n    readonly fileId: TeamBattleFileId;\n    readonly taskId: TeamBattleTaskId;\n    readonly expectedTaskRevision: number;\n}',
  },
  {
  ...
  {
    name: 'TeamBattleActivityId',
    declaration: 'export type TeamBattleActivityId = Branded<\'TeamBattleActivityId\'>;',
  },
  {
    name: 'TeamBattleActivityType',
    declaration: 'export type TeamBattleActivityType = \'task_created\' | \'task_updated\' | \'context_published\' | \'artifact_published\' | \'artifact_reviewed\' | \'weapon_granted\' | \'weapon_consumed\' | \'member_heartbeat\';',
  },
  {
    name: 'TeamBattleActivityView',
    declaration: 'export interface TeamBattleActivityView {\n    readonly id: TeamBattleActivityId;\n    readonly type: TeamBattleActivityType;\n    readonly memberId: TeamBattleMemberId;\n    readonly createdAt: number;\n    readonly taskId?: TeamBattleTaskId;\n    readonly artifactId?: TeamBattleArtifactId;\n    readonly weaponId?: TeamBattleWeaponId;\n    readonly eventId?: string;\n}',
  },
  {
    name: 'TeamBattleActorRequest',
    declaration: 'export interface TeamBattleActorRequest {\n    readonly teamId?: TeamBattleProjectId;\n    readonly actingMemberId?: TeamBattleMemberId;\n}',
  },
  {
    name: 'TeamBattleArtifactId',
    declaration: 'export type TeamBattleArtifactId = Branded<\'TeamBattleArtifactId\'>;',
  },
  {
    name: 'TeamBattleArtifactReview',
    declaration: 'export interface TeamBattleArtifactReview {\n    readonly status: TeamBattleArtifactReviewStatus;\n    readonly reviewedByMemberId?: TeamBattleMemberId;\n    readonly reviewedAt?: number;\n    readonly note?: string;\n}',
  },
  {
    name: 'TeamBattleArtifactReviewStatus',
    declaration: 'export type TeamBattleArtifactReviewStatus = \'pending\' | \'accepted\' | \'rejected\';',
  },
  {
    name: 'TeamBattleArtifactView',
    declaration: 'export interface TeamBattleArtifactView {\n    readonly id: TeamBattleArtifactId;\n    readonly revision: number;\n    readonly taskId: TeamBattleTaskId;\n    readonly name: string;\n    readonly mediaType: string;\n    readonly uri: string;\n    readonly sha256: string;\n    readonly bytes: number;\n    readonly createdByMemberId: TeamBattleMemberId;\n    readonly createdAt: number;\n    readonly review: TeamBattleArtifactReview;\n}',
  },
  {
    name: 'TeamBattleCombatShieldView',
    declaration: 'export interface TeamBattleCombatShieldView {\n    readonly hp: number;\n    readonly maxHp: number;\n}',
  },
  {
    name: 'TeamBattleContextId',
    declaration: 'export type TeamBattleContextId = Branded<\'TeamBattleContextId\'>;',
  },
  {
    name: 'TeamBattleContextView',
    declaration: 'export interface TeamBattleContextView {\n    readonly id: TeamBattleContextId;\n    readonly summary: string;\n    readonly decisions: readonly string[];\n    readonly blockers: readonly string[];\n    readonly nextSteps: readonly string[];\n    readonly sourceRefs: readonly string[];\n    readonly createdByMemberId: TeamBattleMemberId;\n    readonly createdAt: number;\n}',
  },
  {
    name: 'TeamBattleDeliveryId',
    declaration: 'export type TeamBattleDeliveryId = Branded<\'TeamBattleDeliveryId\'>;',
  },
  {
    name: 'TeamBattleDeliveryPull',
    declaration: 'export interface TeamBattleDeliveryPull {\n    readonly delivery?: TeamBattleDeliveryView;\n    readonly content?: TeamBattleFileContent;\n}',
  },
  {
    name: 'TeamBattleDeliveryView',
    declaration: 'export interface TeamBattleDeliveryView {\n    readonly id: TeamBattleDeliveryId;\n    readonly fileId: TeamBattleFileId;\n    readonly fileRevision: number;\n    readonly memberId: TeamBattleMemberId;\n    readonly createdAt: number;\n    readonly status: \'queued\' | \'delivered\' | \'failed\';\n    readonly acknowledgedAt?: number;\n    readonly note?: string;\n}',
  },
  {
    name: 'TeamBattleDirectoryView',
    declaration: 'export interface TeamBattleDirectoryView {\n    readonly teams: readonly TeamBattleTeamSummary[];\n    readonly hosting: TeamBattleHostingStatus;\n}',
  },
  {
    name: 'TeamBattleFileContent',
    declaration: 'export interface TeamBattleFileContent {\n    readonly file: TeamBattleFileView;\n    readonly contentBase64: string;\n}',
  },
  {
    name: 'TeamBattleFileId',
    declaration: 'export type TeamBattleFileId = Branded<\'TeamBattleFileId\'>;',
  },
  {
    name: 'TeamBattleFileView',
    declaration: 'export interface TeamBattleFileView {\n    readonly id: TeamBattleFileId;\n    readonly parentId?: TeamBattleFolderId;\n    readonly revision: number;\n    readonly name: string;\n    readonly mediaType: string;\n    readonly bytes: number;\n    readonly sha256: string;\n    readonly versionLabel: string;\n    readonly note: string;\n    readonly source: string;\n    readonly createdByMemberId: TeamBattleMemberId;\n    readonly createdAt: number;\n    readonly updatedAt: number;\n    readonly artifactId?: TeamBattleArtifactId;\n    readonly taskId?: TeamBattleTaskId;\n    readonly review?: TeamBattleArtifactReview;\n}',
  },
  {
    name: 'TeamBattleFolderId',
    declaration: 'export type TeamBattleFolderId = Branded<\'TeamBattleFolderId\'>;',
  },
  {
    name: 'TeamBattleFolderView',
    declaration: 'export interface TeamBattleFolderView {\n    readonly id: TeamBattleFolderId;\n    readonly parentId?: TeamBattleFolderId;\n    readonly revision: number;\n    readonly name: string;\n    readonly createdByMemberId: TeamBattleMemberId;\n    readonly createdAt: number;\n    readonly updatedAt: number;\n}',
  },
  {
    name: 'TeamBattleHostingStatus',
    declaration: 'export interface TeamBattleHostingStatus {\n    readonly running: boolean;\n    readonly host?: string;\n    readonly port?: number;\n    readonly origins: readonly string[];\n}',
  },
  {
    name: 'TeamBattleIngressEvent',
    declaration: 'export interface TeamBattleIngressEvent {\n    readonly version: 1;\n    readonly type: \'query\';\n    readonly eventId: string;\n    readonly memberId: TeamBattleMemberId;\n    readonly occurredAt: number;\n}',
  },
  {
    name: 'TeamBattleIngressReceipt',
    declaration: 'export interface TeamBattleIngressReceipt {\n    readonly eventId: string;\n    readonly duplicate: boolean;\n    readonly weaponId: TeamBattleWeaponId;\n}',
  },
  {
    name: 'TeamBattleInviteView',
    declaration: 'export interface TeamBattleInviteView {\n    readonly id: string;\n    readonly memberId: TeamBattleMemberId;\n    readonly memberName: string;\n    readonly memberRole: string;\n    readonly expiresAt: number;\n    readonly status: \'pending\' | \'used\' | \'revoked\' | \'expired\';\n}',
  },
  {
    name: 'TeamBattleMemberAccessView',
    declaration: 'export interface TeamBattleMemberAccessView {\n    readonly memberId: TeamBattleMemberId;\n    readonly status: \'active\' | \'revoked\' | \'expired\';\n    readonly expiresAt?: number;\n}',
  },
  {
    name: 'TeamBattleMemberId',
    declaration: 'export type TeamBattleMemberId = Branded<\'TeamBattleMemberId\'>;',
  },
  {
    name: 'TeamBattleMemberStatus',
    declaration: 'export type TeamBattleMemberStatus = \'online\' | \'idle\' | \'offline\';',
  },
  {
    name: 'TeamBattleMemberView',
    declaration: 'export interface TeamBattleMemberView {\n    readonly id: TeamBattleMemberId;\n    readonly name: string;\n    readonly role: string;\n    readonly color?: string;\n    readonly status: TeamBattleMemberStatus;\n    readonly lastSeenAt?: number;\n}',
  },
  {
    name: 'TeamBattleNetworkRequest',
    declaration: 'export interface TeamBattleNetworkRequest {\n    readonly origin: string;\n    readonly path: \'join\' | \'call\' | \'create\';\n    readonly body: unknown;\n    readonly bearer?: string;\n}',
  },
  {
    name: 'TeamBattleNetworkTransport',
    declaration: 'export interface TeamBattleNetworkTransport {\n    status(): TeamBattleHostingStatus;\n    start(request: {\n        readonly host: string;\n        readonly port: number;\n    }): Promise<TeamBattleHostingStatus>;\n    stop(): Promise<void>;\n    request(request: TeamBattleNetworkRequest): Promise<unknown>;\n}',
  },
  {
    name: 'TeamBattleProgressView',
    declaration: 'export interface TeamBattleProgressView {\n    readonly acceptedWeight: number;\n    readonly totalWeight: number;\n    readonly percent: number;\n    readonly coreHp: number;\n    readonly coreMaxHp: number;\n}',
  },
  {
    name: 'TeamBattleProjectId',
    declaration: 'export type TeamBattleProjectId = Branded<\'TeamBattleProjectId\'>;',
  },
  {
    name: 'TeamBattleSpaceLimits',
    declaration: 'export interface TeamBattleSpaceLimits {\n    readonly maxFileBytes: number;\n    readonly maxTotalFileBytes: number;\n    readonly maxItems: number;\n    readonly maxDeliveries: number;\n}',
  },
  {
    name: 'TeamBattleSpaceView',
    declaration: 'export interface TeamBattleSpaceView {\n    readonly revision: number;\n    readonly folders: readonly TeamBattleFolderView[];\n    readonly files: readonly TeamBattleFileView[];\n    readonly deliveries: readonly TeamBattleDeliveryView[];\n    readonly limits: TeamBattleSpaceLimits;\n}',
  },
  {
    name: 'TeamBattleTaskId',
    declaration: 'export type TeamBattleTaskId = Branded<\'TeamBattleTaskId\'>;',
  },
  {
    name: 'TeamBattleTaskStatus',
    declaration: 'export type TeamBattleTaskStatus = \'open\' | \'in_progress\' | \'submitted\' | \'completed\';',
  },
  {
    name: 'TeamBattleTaskView',
    declaration: 'export interface TeamBattleTaskView {\n    readonly id: TeamBattleTaskId;\n    readonly revision: number;\n    readonly title: string;\n    readonly description: string;\n    readonly weight: number;\n    readonly status: TeamBattleTaskStatus;\n    readonly createdByMemberId: TeamBattleMemberId;\n    readonly ownerMemberId?: TeamBattleMemberId;\n    readonly createdAt: number;\n    readonly updatedAt: number;\n}',
  },
  {
    name: 'TeamBattleTeamSummary',
    declaration: 'export interface TeamBattleTeamSummary {\n    readonly id: TeamBattleProjectId;\n    readonly name: string;\n    readonly goal: string;\n    readonly mode: \'hosted\' | \'joined\' | \'legacy\';\n    readonly localMemberId: TeamBattleMemberId;\n    readonly ownerMemberId: TeamBattleMemberId;\n    readonly storageLocation: string;\n    readonly hostUrl?: string;\n    readonly invites: readonly TeamBattleInviteView[];\n    readonly memberAccess: readonly TeamBattleMemberAccessView[];\n}',
  },
  {
    name: 'TeamBattleView',
    declaration: 'export interface TeamBattleView {\n    readonly simulationEnabled: boolean;\n    readonly revision: number;\n    readonly localMemberId: TeamBattleMemberId;\n    readonly project: {\n        readonly id: TeamBattleProjectId;\n        readonly name: string;\n        readonly goal: string;\n    };\n    readonly members: readonly TeamBattleMemberView[];\n    readonly tasks: readonly TeamBattleTaskView[];\n    readonly contexts: readonly TeamBattleContextView[];\n    readonly artifacts: readonly TeamBattleArtifactView[];\n    readonly activity: readonly TeamBattleActivityView[];\n    readonly weaponGrants: readonly TeamBattleWeaponGrantView[];\n    readonly progress: TeamBattleProgressView;\n    readonly combatShield: TeamBattleCombatShieldView;\n}',
  },
  {
    name: 'TeamBattleWeaponGrantView',
    declaration: 'export interface TeamBattleWeaponGrantView {\n    readonly id: TeamBattleWeaponId;\n    readonly eventId: string;\n    readonly memberId: TeamBattleMemberId;\n    readonly kind: \'query\';\n    readonly shieldDamage: number;\n    readonly createdAt: number;\n    readonly consumedAt?: number;\n}',
  },
  {
  ...
  {
    name: 'UpdateSpaceItemRequest',
    declaration: 'export interface UpdateSpaceItemRequest extends TeamBattleActorRequest {\n    readonly kind: \'folder\' | \'file\';\n    readonly id: TeamBattleFolderId | TeamBattleFileId;\n    readonly expectedRevision: number;\n    readonly action: \'rename\' | \'delete\';\n    readonly name?: string;\n}',
  },
  {
    name: 'UpdateTaskAction',
    declaration: 'export type UpdateTaskAction = \'claim\' | \'release\' | \'edit\' | \'submit\' | \'reopen\' | \'delete\' | \'handoff\';',
  },
  {
    name: 'UpdateTaskRequest',
    declaration: 'export interface UpdateTaskRequest extends TeamBattleActorRequest {\n    readonly taskId: TeamBattleTaskId;\n    readonly expectedRevision: number;\n    readonly action: UpdateTaskAction;\n    readonly targetMemberId?: TeamBattleMemberId;\n    readonly note?: string;\n    readonly title?: string;\n    readonly description?: string;\n    readonly weight?: number;\n}',
  },
  {
