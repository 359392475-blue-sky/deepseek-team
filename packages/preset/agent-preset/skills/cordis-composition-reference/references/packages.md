...
| `@deepseek-ai/dsh-experimental-client-ui-team-battle` | no | Web Team Battle project space and optional conversation flight game |
...
| `@deepseek-ai/dsh-experimental-team-battle` | yes | Durable team spaces, authenticated shared-server collaboration, and legacy combat projection |
| `@deepseek-ai/dsh-experimental-team-battle-connector-http` | yes | Bearer-authenticated HTTP ingress for content-free Team Battle connector events |
