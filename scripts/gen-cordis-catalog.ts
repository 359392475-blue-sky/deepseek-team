...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RevokeTeamInviteRequest: 'team-battle.md',
  RevokeTeamMemberRequest: 'team-battle.md',
  JoinRemoteTeamRequest: 'team-battle.md',
  TeamBattleHostingStatus: 'team-battle.md',
  CreateHostedTeamRequest: 'team-battle.md',
  AcceptTeamInviteRequest: 'team-battle.md',
  AuthenticatedTeamRequest: 'team-battle.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  TeamBattleSpaceView: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  CreateFolderRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  PublishFileRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  UpdateSpaceItemRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  ReadFileRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  TeamBattleFileContent: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  SendFileRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  SubmitFileRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  PullDeliveryRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  TeamBattleDeliveryPull: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  AcknowledgeDeliveryRequest: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  TeamBattleDeliveryView: 'experimental Team Battle API is owned by packages/experimental/team-battle/README.md',
  TeamBattleActorRequest: 'local simulation identity is owned by packages/experimental/team-battle/README.md',
  CreateTaskRequest: 'private project API is owned by packages/experimental/team-battle/README.md',
  UpdateTaskRequest: 'private project API is owned by packages/experimental/team-battle/README.md',
  PublishContextRequest: 'private project API is owned by packages/experimental/team-battle/README.md',
  PublishArtifactRequest: 'private project API is owned by packages/experimental/team-battle/README.md',
  ReviewArtifactRequest: 'private project API is owned by packages/experimental/team-battle/README.md',
  ConsumeWeaponRequest: 'private project API is owned by packages/experimental/team-battle/README.md',
  HeartbeatRequest: 'private project API is owned by packages/experimental/team-battle/README.md',
  TeamBattleIngressEvent: 'private project API is owned by packages/experimental/team-battle/README.md',
  TeamBattleIngressReceipt: 'private project API is owned by packages/experimental/team-battle/README.md',

  TeamBattleView: 'private project state is owned by packages/experimental/team-battle/README.md',
